...
# #loading in sounds
# hi_hat = mixer.Sound('beatmaker/basickit/hi hat.wav')
# bass = mixer.Sound('beatmaker/basickit/bass.wav')
# crash = mixer.Sound('beatmaker/basickit/cymbal.wav')
# snare = mixer.Sound('beatmaker/basickit/snare.WAV')
# tom = mixer.Sound(r'beatmaker/basickit/tom.WAV')
# clap = mixer.Sound('beatmaker/basickit/clap.wav')
